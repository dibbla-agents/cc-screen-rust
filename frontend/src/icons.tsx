...
// Three nodes joined by two links — the "share with another user" action
// (proposal 0041). Lucide's share-2 glyph.
...
// An open tray — the share-invite inbox (proposal 0041). Lucide's inbox glyph.
...
// A speech bubble — in-app session-ready toasts (proposal 0017). `filled`
// paints it solid (toasts on) vs hollow (off); `off` adds a slash. Sits beside
// the BellIcon (OS Web Push) in the drawer; the bubble vs bell split reads as
// "in-app popup" vs "buzz my phone".
